...
| **5** | 기능<br>(목표) | 도서 진척도 상세 | ▪︎ 선택 도서의 상세 기능을 제공하고, 목표 달성 현황을 텍스트와 그래프로 한 눈에 볼 수 있도록 함 <br> → ⌜독서 완료⌟, ⌜목표 수정⌟, ⌜목표 삭제⌟ 기능을 제공하고, 완독 목표 달성일까지 D-Day, 일일 독서 현황 막대 그래프 정보를 표시하도록 함 <br> ▪︎ 한줄 글귀 수집 기능으로 인상 깊은 문장을 수집할 수 있도록 함 |
...
| **9** | 기능<br>(검색) | 도서 검색 | ▪︎ 국내 도서를 검색하는 기능을 제공하도록 함 <br> → 도서 표지(Cover), 제목, 부제, 분류, 저자, 출판일 정보를 간략하게 표시하도록 함 | `1` | |
| **10** | 기능<br>(검색) | 검색 상세 | ▪︎ 검색한 도서 정보를 상세하게 보여주도록 함 <br> → 도서 표지(Cover), 제목, 부제, 분류, 저자, 출판일, 도서 설명 정보를 표시하도록 함 | `1` | |
...
| **13** | 기능<br>(분석) | 분석 결과 보기 | ▪︎ 지금까지 완독한 모든 도서의 분석 결과를 제공하도록 함 <br> → 읽고 있는 도서와 완독한 도서의 개수, 일일 (전체) 독서 현황 막대 그래프와 연속 독서 스트릭 정보를 표시하도록 함 <br> → 페이지 캘린더로 어느 일자나 얼마나(페이지) 읽었는지 한 눈에 볼 수 있도로 함 | `3` | |
...
| **6** | 검색 | 도서 검색 | ▪︎ 도서 명/저자 명으로 도서 검색 기능을 지원하고자 함 | | - Hero Animation |
...
| | | | ▪︎ 페이지 캘린더로 어느 일자나 얼마나(페이지) 읽었는지 한 눈에 볼 수 있도로 함 | | |
