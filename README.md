...
| :--: | :--: | :-- | :-- | :--: | :-- |
| **1** | 로그인 | 인트로・스플래시 | ▪︎ 스플래시 로딩 이미지 출력하기 <br> ▪︎ 앱 소개 출력 / 닉네임, 프로필 이미지 입력 | | | 
|   | | SNS 로그인 | ▪︎ 애플로 로그인하기 | | - SNS로그인이 아닌 iCloud로 기기 간 동기화를 지원할 수도 있음 | 
| **2** | 프로필 | 프로필 관리 | ▪︎ 프로필 이미지 보기 | | |
| | | | ▪︎ 앱 사용자 테마 설정하기 | | |
|   | | | ▪︎ In-App-Purchase 및 구독 관리하기 | | |
| **3** | 홈 | 목표 도서 보기 | ▪︎ 카테고리 별 보기 | | |
|   | | 목표 도서 정렬 | ▪︎ 순서 정렬 및 필터링하기 | | |
|   | | 목표 도서 상세 | ▪︎ 목표 달성 현황 보기 | | |
|   | | | ▪︎ 도서 평점(추가/수정/삭제) 보기 | | |
|   | | | ▪︎ 문장 수집(추가/수정/삭제) 보기 | | |
| **4** | 도서 | 목표 도서 추가 | ▪︎ 목표 도서 추가하기 <br> → [수동 추가]: 직접 도서 제목 등 정보를 입력해 추가 <br> → [검색 추가]: 알라딘에서 검색한 도서를 추가 | | |
|   |  | 목표 도서 수정 | ▪︎ 목표 도서 정보 수정하기 (목표 완독일 등) | | |
|   |  | 목표 도서 삭제 | ▪︎ 목표 도서 정보 삭제하기 | | |
| **6** | 검색 | 도서 검색 | ▪︎ 도서 검색하기 (제목/저자) | `100%`|  |
|   | | 검색 상세 | ▪︎ 검색 도서 상세 보기 | `100%` | |
| **7** | 책장 | 찜한・읽은 도서 보기 | ▪︎ 찜한 도서 보기  <br> → 검색 및 필터링 기능 등 | `100%` | |
|   | | | ▪︎ 읽은 도서 보기 <br> → 검색 및 필터링 기능 등 | | |
|   | | 찜한・읽은 도서 상세 | ▪︎ 찜한 도서 상세 보기 | `100%` | |
|   | | | ▪︎ 읽은 도서 상세 보기 | | |
