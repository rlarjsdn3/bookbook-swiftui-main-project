...
|   | | 목표 도서 상세 | ▪︎ 목표 달성 현황 보기 | `0%` | |
|   | | | ▪︎ 문장 수집 보기(추가/수정/삭제) | `0%` | |
|   | | 목표 도서 수정 | ▪︎ 목표 도서 정보 수정하기 (목표 완독일 등) | | |
|   | | 목표 도서 삭제 | ▪︎ 목표 도서 정보 삭제하기 | | |
...
|   | | 수집 문장 보기 | ▪︎ 수집 문장 보기  <br> → 검색 및 필터링 기능 등 | `0%` | |
|   | | 찜한 도서 상세 | ▪︎ 찜한 도서 상세 보기 | `100%` | |
|   | | 읽은 도서 상세 | ▪︎ 읽은 도서 상세 보기 | `0%` | |
|   | | 수집 문장 상세 | ▪︎ 수집 문장 상세 보기 | `0%` | |
