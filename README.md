...
| **3** | 홈 화면 | 목표 도서 보기 | ▪︎ 카테고리 별 보기 | `20%` | |
|   | | 목표 도서 정렬 | ▪︎ 정렬 및 필터링하기 | `0%` | |
|   | | 목표 도서 상세 | ▪︎ 목표 달성 현황 보기 | | |
|   | | | ▪︎ 문장 수집 보기(추가/수정/삭제) | | |
|   | | 목표 도서 수정 | ▪︎ 목표 도서 정보 수정하기 (목표 완독일 등) | | |
|   | | 목표 도서 삭제 | ▪︎ 목표 도서 정보 삭제하기 | | |
| **6** | 검색 | 도서 검색 | ▪︎ 도서 검색하기 (제목/저자) | `100%`|  |
|   | | 검색 상세 | ▪︎ 검색 도서 상세 보기 | `100%` | |
|   | | 목표 도서 추가 | ▪︎ 목표 도서 추가하기 <br> → [수동 추가]: 직접 도서 제목 등 정보를 입력해 추가 <br> → [검색 추가]: 알라딘에서 검색한 도서를 추가 | `40%` | |
