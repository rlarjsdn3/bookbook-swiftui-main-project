...
| **8** | | 좋아요・완독 도서 상세 | ▪︎ 완독 도서의 세부 정보를 볼 수 있도록 함| | - Hero Animation |
| **9** | 분석 | 분석 결과 보기 | ▪︎ 읽고 있는 도서와 완독한 도서의 개수, 일일 (전체) 독서 현황 막대 그래프와 연속 독서 스트릭 정보를 표시하도록 함 | | - Charts |
| **10** | 디자인 | 커스텀 탭뷰 | ▪︎ 디폴트 탭뷰(TabView)가 아닌 다채로운 애니메이션이 적용된 탭뷰를 적용하도록 함 | | |
